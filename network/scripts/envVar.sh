...
export PEER0_SUPERVISORS_CA=${PWD}/organizations/peerOrganizations/supervisors.put.poznan.pl/peers/peer0.supervisors.put.poznan.pl/tls/ca.crt
export PEER0_STUDENTS_CA=${PWD}/organizations/peerOrganizations/students.put.poznan.pl/peers/peer0.students.put.poznan.pl/tls/ca.crt
...
setGlobals() {
  ...
  if [ $USING_ORG == "supervisors" ]; then
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_SUPERVISORS_CA
